...
Puret does not create the translation model dynamically (like model_translations does) but creates the file via generator. I want to leave out as much magic as possible in order to allow customizing every part of your application.
...
If a translation is not available in your locale, puret looks for a translation in I18n.default_locale. In case a translation is not available in the default locale, too, puret uses the first locale it could find. That order is not specified by now. I am working on a more sophisticated approach, be sure to keep track of the puret development and please feel free to drop me a line if you have worked out something useful.
